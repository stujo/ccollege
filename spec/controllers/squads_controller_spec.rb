  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved squad as @squad" do
        ...
        post :create, {:squad => { "color" => "invalid value" }}, valid_session
        assigns(:squad).should be_a_new(Squad)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested squad" do
        ...
        Squad.any_instance.should_receive(:update).with({ "color" => "MyString" })
        put :update, {:id => squad.to_param, :squad => { "color" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the squad as @squad" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Squad.any_instance.stub(:save).and_return(false)
        put :update, {:id => squad.to_param, :squad => { "color" => "invalid value" }}, valid_session
        assigns(:squad).should eq(squad)
      end
